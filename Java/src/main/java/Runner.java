...
public class Runner {
    static List<Plane> passengerPlanes = Arrays.asList(
    ...
    static List<Plane> militaryPlanes = Arrays.asList(
    ...
    public static void main(String[] args) {
        Airport militaryAirport = new Airport(passengerPlanes);
        Airport passengerAirport = new Airport(militaryPlanes);
